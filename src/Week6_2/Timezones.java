...
public class Timezones {
    ...
    public static void main(String[] args) {
        ...
        String timeString;
        DateTimeFormatter dfIn = DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm");
        System.out.println("Type the timestamp: ");
        ...
        LocalDateTime ldt1 = LocalDateTime.parse(timeString, dfIn);
        ...
        LocalDateTime ldt2 = LocalDateTime.parse(timeString, dfIn);
        ...
        LocalDateTime ldt3 = LocalDateTime.parse(timeString, dfIn);
        ...
        LocalDateTime ldt4 = LocalDateTime.parse(timeString, dfIn);
        ...
        LocalDateTime ldt5 = LocalDateTime.parse(timeString, dfIn);
        ...
        LocalDateTime ldt6 = LocalDateTime.parse(timeString, dfIn);
        ...
        LocalDateTime ldt7 = LocalDateTime.parse(timeString, dfIn);
